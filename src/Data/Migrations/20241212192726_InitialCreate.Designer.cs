...
namespace NASRAC.Data.Migrations
{
    ...
    [Migration("20241212192726_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NASRAC.Core.Entities.Game.Car", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("NASRAC.Core.Entities.Game.Driver", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("NASRAC.Core.Entities.Game.Loan", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("BorrowingTeamId")
                        .HasColumnType("integer");

                    b.Property<double>("InterestRate")
                        .HasColumnType("double precision");

                    b.Property<int>("LendingTeamId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("NASRAC.Core.Entities.Game.Manufacturer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("NASRAC.Core.Entities.Game.QualifyingStats", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("NASRAC.Core.Entities.Game.Race", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("NASRAC.Core.Entities.Game.RaceLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("NASRAC.Core.Entities.Game.Schedule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("NASRAC.Core.Entities.Game.Series", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("NASRAC.Core.Entities.Game.SessionResults", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("NASRAC.Core.Entities.Game.Sponsor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("NASRAC.Core.Entities.Game.Team", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("NASRAC.Core.Entities.Game.TeamFinancials", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("NASRAC.Core.Entities.Game.TeamManufacturers", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("NASRAC.Core.Entities.Game.Track", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("NASRAC.Core.Entities.Game.Car", b =>
                {
                    b.HasOne("NASRAC.Core.Entities.Game.Manufacturer", null)
                        .WithMany("Cars")
                        .HasForeignKey("ManufacturerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("NASRAC.Core.Entities.Game.Team", null)
                        .WithMany("Cars")
            ...
            modelBuilder.Entity("NASRAC.Core.Entities.Game.Driver", b =>
                {
                    b.HasOne("NASRAC.Core.Entities.Game.Team", "Team")
                        .WithMany("Drivers")
                        .HasForeignKey("TeamId");
            ...
            modelBuilder.Entity("NASRAC.Core.Entities.Game.QualifyingStats", b =>
                {
                    b.HasOne("NASRAC.Core.Entities.Game.Driver", "Driver")
                        .WithMany()
                        .HasForeignKey("DriverId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("NASRAC.Core.Entities.Game.Race", "Race")
                        .WithMany()
            ...
            modelBuilder.Entity("NASRAC.Core.Entities.Game.Race", b =>
                {
                    b.HasOne("NASRAC.Core.Entities.Game.Track", "Track")
                        .WithMany()
